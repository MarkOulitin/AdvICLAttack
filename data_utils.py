...
def load_ethos_binary():
    ...
    train_labels = [label for text, label in zip(train_sentences, train_labels) if len(text.split(" ")) < 30]
    train_sentences = [text for text in train_sentences if len(text.split(" ")) < 30]
